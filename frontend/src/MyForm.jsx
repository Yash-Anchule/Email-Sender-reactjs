...
export default function MyForm() {
  ...
  //   <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
  //     <button style="background-color: #0077B5; color: white; padding: 10px; border: none; cursor: pointer; display: inline-block;">
  //       Move to LinkedIn
  //     </button>
  //   </a>
  // `;

  // const emailBodyWithLinkedInButton = `${message}\n\n${linkedInButton}`;

  // let dataSend = {
  //   email: email,
  //   subject: subject,
  //   message: emailBodyWithLinkedInButton,
  //   emails: emails,
  // };
    let dataSend = {
      email: email,
    ...
    try {
      ...
      console.log("The stauts of res is ", res.status);
